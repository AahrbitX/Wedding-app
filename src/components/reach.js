  ...
  return (
    <div className="bg-black rounded-3xl text-center flex flex-col justify-center mt-60 p-20">
      ...
      <div className="w-full flex flex-col justify-center items-center">
        <h1 className="text-3xl flex md:w-[800px] w-full text-white font-bold py-20"> Congratulations to the beautiful couple! May your love grow stronger with each passing day.</h1> 
        <p  className="">
          -Pommi Caters
        </p>
      </div>
